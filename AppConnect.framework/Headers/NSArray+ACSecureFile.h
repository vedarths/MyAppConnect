/*!
 * @header NSArray+ACSecureFile.h
 *
 * @abstract Category of NSArray adding AppConnect Secure File IO
 *
 ...
 */
@interface NSArray (ACSecureFile)

/*! */
+ (nullable instancetype)arrayWithContentsOfSecureFile:(NSString *)path error:(NSError *__autoreleasing*)error;
/*! */
+ (nullable instancetype)arrayWithContentsOfSecureURL:(NSURL *)aURL error:(NSError *__autoreleasing*)error;
